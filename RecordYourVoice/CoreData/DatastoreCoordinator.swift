...
class DatastoreCoordinator: NSObject {
    fileprivate let objectModelName = "RecordYourVoice"
    fileprivate let objectModelExtension = "momd"
    fileprivate let dbFilename = "RecordYourVoice.sqlite"
    fileprivate let appDomain = "com.RecordYourVoice"
    ...
    lazy var persistentStoreCoordinator: NSPersistentStoreCoordinator = {
        ...
        do {
            ...
            printNew(items:"Unresolved error \(wrappedError), \(wrappedError.userInfo)")
