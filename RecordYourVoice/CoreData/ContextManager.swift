    ...
    func saveContext() {
        defer {
            do {
                ...
                printNew(items: "Master Managed Object Context save error: \(masterMocSaveError.localizedDescription)")
            } catch {
                printNew(items: "Master Managed Object Context save error.")
            }
        }
    ...
    fileprivate func mergeChangesFromMainContext() {
        DispatchQueue.main.async(execute: {
            do {
                ...
                printNew(items: "Master Managed Object Context error: \(mocSaveError.localizedDescription)")
            }
        })
    }
